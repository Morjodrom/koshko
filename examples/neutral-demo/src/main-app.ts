...
function wireInspectorDock(): void {
  const dock = document.querySelector<HTMLElement>('#koshko-inspector-dock');
  const toggle = document.querySelector<HTMLButtonElement>('#toggle-koshko-inspector');
